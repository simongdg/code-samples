__global__ void Reduce_133(int *Return_23, int *input_x_14, int SourceSize_24,
                          int ObjectSize_25) {
  ...
  if(threadIdx.x == 0)
  atomicAdd_system(Return_23, shared_16);
}

__global__ void Reduce_132_22(int *Return_29, int *input_x_14, int SourceSize_30,
...
void tangram_dTile_Va1s_Va2(int *input_x_7, int *out, int ObjectSize_35, int blockNum) {
  ...
  dim3 dimGrid(p_8);
  Reduce_132_22 << <dimGrid, dimBlock>>>
