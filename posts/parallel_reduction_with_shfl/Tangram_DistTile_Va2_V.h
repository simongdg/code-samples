__global__ void Reduce_13_8(int *Return_26, int *input_x_14, int SourceSize_27,
...
__global__ void Reduce_138(int *Return_23, int *input_x_14, int SourceSize_24,
                          int ObjectSize_25) {
...
void tangram_dTile_Va2_V(int *input_x_7, int *out, int ObjectSize_35, int blockNum) {
  ...
  dim3 dimGrid(p_8);
  Reduce_138 << <dimGrid, dimBlock>>>
      (out, input_x_7, x_size_9, tile_10);

  Reduce_13_8 << <1, p_8, p_8*sizeof(int)>>>
