__inline__ __device__ int Reduce_28(int *input_x_26, int SourceSize_37,
...
__inline__ __device__ void Reduce_23(int *Return_41, int *input_x_21,
...
__global__ void Reduce_16(int *Return_47, int *input_x_14, int ObjectSize_48,
  ...
  Reduce_23(map_return_4, part_19 + (0 + (threadIdx.x * 1)), x_size_16,
            SourceSize_50, (p_15 * tile_17), p_15);

  __syncthreads();
  ;
  ;
  int result_24 = Reduce_28(map_return_4, p_15, p_15, p_15, p_15);
...
void tangram_dTileAtom_dStride_S_Va1(int *input_x_7, int *out, int ObjectSize_52, int blockNum, int threadNum) {
  ...
  dim3 dimGrid(p_8);
  Reduce_16 << <dimGrid, dimBlock, threadNum*sizeof(int)>>>
