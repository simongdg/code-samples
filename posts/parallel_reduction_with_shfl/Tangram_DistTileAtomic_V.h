__global__ void Reduce_13_1(int *Return_26, int *input_x_14, int SourceSize_27,
...
void tangram_dTileAtom_V(int *input_x_7, int * out, int ObjectSize_33, int blockNum) {
  ...
  dim3 dimGrid(p_8);
  Reduce_13_1 << <dimGrid, dimBlock, tile_10 * sizeof(int)>>>
