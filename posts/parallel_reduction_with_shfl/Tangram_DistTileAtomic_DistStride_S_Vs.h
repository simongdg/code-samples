__inline__ __device__ int Reduce_29(int *input_x_26, int SourceSize_38,
  ...
  if (((ObjectSize_40 != 32) && ((ObjectSize_41 / 32) > 0))) {
    ...
    if ((threadIdx.x / warpSize == 0)) {
      ...
      for (int offset_32 = (32 / 2); (offset_32 > 0); offset_32 /= 2) {
        val_30 += __shfl_down(val_30, offset_32, 32);
        ;
      }
    };
  };
...
__inline__ __device__ void Reduce_24(int *Return_41, int *input_x_21,
...
__global__ void Reduce_17(int *Return_47, int *input_x_14, int ObjectSize_48,
  ...
  Reduce_24(map_return_4, part_19 + (0 + (threadIdx.x * 1)), x_size_16,
            SourceSize_50, (p_15 * tile_17), p_15);

  __syncthreads();
  ;
  ;
  int result_24 = Reduce_29(map_return_4, p_15, p_15, p_15, p_15, p_15);
...
void tangram_dTileAtom_dStride_S_Vs(int *input_x_7, int *out, int ObjectSize_52, int blockNum, int threadNum) {
