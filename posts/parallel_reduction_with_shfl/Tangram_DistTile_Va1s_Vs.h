__global__ void Reduce_123(int *Return_26, int *input_x_14, int SourceSize_27,
...
__global__ void Reduce_132_21(int *Return_29, int *input_x_14, int SourceSize_30,
...
void tangram_dTile_Va1s_Vs(int *input_x_7, int *out, int ObjectSize_35, int blockNum) {
  ...
  dim3 dimGrid(p_8);
  Reduce_132_21 << <dimGrid, dimBlock>>>
